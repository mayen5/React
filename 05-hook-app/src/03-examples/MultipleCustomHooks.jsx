    ...
    <>
...

      {
        !!data && data && state >= 0 && family
          ? (
            <>
              <button disabled={isLoading} onClick={() => decrement(1)} className="btn btn-primary"> Previous Character </button>
              <button disabled={isLoading} onClick={() => reset()} className="btn btn-primary"> Reset </button>
              <button disabled={isLoading} onClick={() => increment(1)} className="btn btn-primary"> Next Character </button>
            </>
